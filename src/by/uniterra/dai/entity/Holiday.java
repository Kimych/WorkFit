...
@NamedQueries(
        {
            ...
            @NamedQuery(name = Holiday.NQ_FIND_HOLIDAY_BY_WORKER_AND_YEAR, query = "SELECT h.countDays FROM Holiday h JOIN h.year y WHERE h.worker = :" + Holiday.PARAMETER_WORKER + " and y.number = :" + Holiday.PARAMETER_YEAR) 
        })
