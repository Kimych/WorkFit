...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        // TODO codehack: add EntityManager to a WorkerrService class like a member, initialize it in a constructor (like new WorkerrService(em)) 
        // and after that you can call "PrintAllWorkers" and "save" methods without "em" in arguments (like service.PrintAllWorkers(), service.save(work1)).  
