 ...
 */
public class UTCheckBoxList extends JList
{
    ...
    /**
     * A specialized CellRenderer for the UTCheckBoxList
     * 
     * @author fracpete (fracpete at waikato dot ac dot nz)
     * @version $Revision: 8034 $
     * @see UTCheckBoxList
    ...
    public class CheckBoxListRenderer extends JCheckBox implements ListCellRenderer
    {
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus)
        {
            ...
            setSelected(((UTCheckBoxList) list).getChecked(index));
            setFocusPainted(false);
            setEnabled(UTCheckBoxList.this.isEnabled());
            return this;
        }
    }
     ...
     */
    public UTCheckBoxList(CheckBoxListModel model)
    {
        super();
        ...
        addMouseListener(new MouseAdapter()
        {
            public void mousePressed(MouseEvent e)
            {
                ...
                if (index != -1 && ((JComponent)e.getSource()).isEnabled())
                {
        ...
        addKeyListener(new KeyAdapter()
        {
            ...
            {
                if ((e.getKeyChar() == ' ') && (e.getModifiers() == 0) &&  ((JComponent)e.getSource()).isEnabled())
                {
    ...
    /**
     * Get list of selected user objects
     * 
     * @return List<Object>  with selected object items
     *
    ...
    public List<?> getSelectedItems()
    {
        ...
        for (int i = 0; i < getModel().getSize(); i++)
        {
            if (getChecked(i))
            {
                lstResult.add(getModel().getElementAt(i));
            }
        }
        return lstResult;
    }
     ...
     * 
     * @param lstItemsToSelect - list of items to be selected
     *
     * @author Anton Nedbailo
     * @date 20 ���. 2013 �.
     */
    public void setSelectedItems(List<?> lstItemsToSelect)
    {
        for (int i = 0; i < getModel().getSize(); i++)
        {
            //compare with user object of a combobox
            setChecked(i, lstItemsToSelect.contains(getModel().getElementAt(i)));
        }
    }
}